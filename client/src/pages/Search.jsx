...
export default function Search() {
    return (
        <div className='flex flex-col md:flex-row text-white bg-zinc-800'>
            <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen'>
                <form className='flex flex-col gap-8'>
                    ...
                    <div className='flex gap-2 flex-wrap items-center'>
                        ...
                        <div className='flex gap-2'>
                            <input type='checkbox' id='privateBathroom' className='w-5' />
                            <span>Private Bathroom</span>
                        </div>
                    </div>
                    <div className='flex items-center gap-2'>
                        <label className='font-semibold'>Sort:</label>
                        <select id='sort_order' className='text-black border rounded-lg p-2'>
            ...
            <div className=''>
                <h1 className='text-3xl font-semibold border-b p-3 text-gray-100 mt-5'>Listing results:</h1>
            </div>
        </div>
    );
}