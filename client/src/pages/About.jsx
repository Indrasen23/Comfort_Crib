  ...
  return (
    <div className="min-h-screen text-white flex flex-col ">
      <div className="max-w-4xl mx-auto px-4">
        <h2 className="text-2xl font-bold mb-4 text-blue-500 pt-4">About Our Website</h2>
        <p className="text-lg mb-8">
          Welcome to ComfortCrib, your trusted partner in the real estate market. We specialize in helping clients buy, sell,
          and rent properties in the most desirable neighborhoods. Our experienced professionals are committed to providing exceptional service
          and making the buying and selling process as smooth as possible. At ComfortCrib, we also offer a unique feature to list your property
          for customers free of cost. Whether you are a first-time buyer or a seasoned investor, we are here to help you every step of the way.
          So, why wait? Do contact us today and help us find your dream home.
        </p>
        <h1 className="text-3xl font-bold mb-8 text-blue-500">About Us</h1>
        <p className="text-lg mb-8">
          Welcome to our website! Our unwavering mission is to help you achieve your real estate goals by providing expert advice, personalized service,
          and an in-depth understanding of the local market. We are three passionate and skilled MERN stack developers - Indrasen, Kunji  and Sarthak.
          We specialize in developing dynamic and responsive websites using MongoDB, Express.js, React.js, and Node.js. Our client-centric approach ensures
          that you have a seamless and hassle-free experience. When it comes to real estate, trust us to be your ultimate partner.
        </p>
        ...
        <div className="flex flex-col justify-around mb-8">
          <div className="flex flex-col items-center">
            ...
            <div className="grid lg:grid-cols-2 sm:grid-cols-1 gap-6">
              ...
              <div>
                <p> am a passionate front end developer with a knack for crafting robust and efficient web applications. With a strong
                  foundation in JavaScript, I specialize in building dynamic and responsive websites using React.js, and Tailwind CSS.</p>
                <p>
                  I have honed my skills through hands-on projects and continuous learning, allowing me to stay updated with the latest trends and technologies in the industry.
                </p>
